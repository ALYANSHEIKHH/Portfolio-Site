      ...
      <section id="about" className="about-section bg-gray-50 py-12">
        <div className="container mx-auto text-center px-4">
          ...
          <p
            ...
            data-aos-delay="400"
          >
            Undergraduate in computer science and pursuing study in Artificial Intelligence, Web 3.0, and the Metaverse.
          </p>

          {/* Meet the Developer Section */}
          <div className="team-section">
            <h2
              className="text-2xl font-semibold text-[#fca61f] mb-6"
              data-aos="fade-up"
              data-aos-duration="1500"
              data-aos-delay="600"
            >
            ...
            <div className="flex justify-center">
              <div
                className="team-card text-center transition-transform transform hover:scale-105 duration-300"
                data-aos="zoom-in"
                data-aos-duration="1500"
                data-aos-delay="800"
              >
                <Image
                  ...
                  src="main.png"
                  alt="Alyan - Developer"
                  className="w-36 h-36 rounded-full mx-auto shadow-lg mb-4 border-4 border-[#fca61f]"
                />
        ...
        <div
          className="absolute left-0 top-1/3 transform -translate-y-1/2 opacity-10 pointer-events-none"
          data-aos="fade-right"
